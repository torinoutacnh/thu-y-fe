...
export function VerifyEmail() {
        ...
        fetch(process.env.REACT_APP_API.concat(UserApiRoute.verifyEmail), {
            ...
            .then((data) => {
                ...
                if (data.message === VerifyError) {
                    s1 = errortype; s2 = titleError; s3 = messageError;
                } else {
                    s1 = successType; s2 = titleSuccess; s3 = messageSuccess;
                }
    ...
    return (
        ...
        <div style={{ display: "flex", justifyContent: "center", alignItems: "center", height: "400px" }}>
            <h1 style={{ textAlign: "center", marginTop: "20%", fontSize: "calc(3vw + 2px)", color: "blue" }}>
