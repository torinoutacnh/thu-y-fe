  ...
  <Document>
    <Page style={styles.body}>
      ...
      <View style={{ display: "flex", flexDirection: "row", flexWrap: "wrap" }}>
        ...
        <Text style={{ fontSize: 10, maxWidth: "40%" }}>{`Nguyễn Văn A`}</Text>
      </View>
      ...
      <View style={{ display: "flex", flexDirection: "row", flexWrap: "wrap" }}>
        ...
        <Text style={{ fontSize: 9, maxWidth: "50%" }}>{`Hồ Chí Minh`}</Text>
      </View>
      ...
      >
        ...
        >
          <Text
            style={{ width: "43%", marginTop: 0, fontSize: 11, color: "white" }}
          >
            {`Điện thoại: `}
          </Text>
          <Text style={{ fontSize: 10, maxWidth: "47%" }}>{`0338786210`}</Text>
        </View>
        ...
        >
          <Text
            style={{ width: "26%", marginTop: 0, fontSize: 11, color: "white" }}
          >
            {`Fax: `}
          </Text>
          <Text style={{ fontSize: 10, maxWidth: "70%" }}>{`123123123`}</Text>
        </View>
        ...
        >
          <Text
            style={{ width: "33%", marginTop: 0, fontSize: 11, color: "white" }}
          >
            {`Email: `}
          </Text>
      ...
      <View style={styles.table}>
        ...
        <View style={[styles.row_body, styles.bold]}>
          <Text
            style={[styles.colBody25, { fontStyle: "bold", color: "white" }]}
          >
            {"Tổng số"}
          </Text>
      ...
      >
        <Text
          style={{ width: "28%", marginTop: 0, fontSize: 11, color: "white" }}
        >
          {`Tổng số (viết bằng chữ): `}
        </Text>
        <Text style={{ fontSize: 10, maxWidth: "67%" }}>{`chín mươi con`}</Text>
      </View>
      ...
      <View style={{ height: "55px", marginTop: "9px" }}>
        ...
        <Text
          style={{ marginTop: 0, fontSize: 11, maxLines: 2, color: "white" }}
        >
          {
      ...
      >
        ...
        >
          <Text
            style={{ marginTop: 0, fontSize: 11, width: "45%", color: "white" }}
          >
        ...
        <View style={{ width: "45%", textAlign: "center" }}>
          ...
          >
            ...
            <Text
              style={{ marginTop: 0, fontSize: 9, width: "30%", maxLines: 1 }}
            >
              {`TP.HCM`}
            </Text>
      ...
      <Text
        style={[styles.note, { fontSize: 8, marginTop: 60, color: "white" }]}
      >
        {
