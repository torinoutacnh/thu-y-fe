...
export default function RegisterPage() {
    return (
        <>
            <h1 style={{ textAlign: "center", fontSize: 20, fontWeight: 'bold' }}>Đăng ký tài khoản</h1>
            <RegisterForm />
        </>
    );
}
...
const RegisterForm = () => {
    ...
    const validateUser = () => {
        if (user.name === null || user.account === null || user.address === null || user.email === null || user.password === null || user.phone === null || user.sex === null)
            return false;
        return true;
    }
    ...
    return (
        ...
        >
            ...
            <Form.Item
                ...
                rules={[{ required: checkConfirmPassword(), message: "Mật khẩu không chính xác" }]}
            >
            ...
            <Form.Item wrapperCol={{ offset: 8, span: 16 }} >
                ...
                <Link
                    to={RouteEndpoints.user.login} style={{ textDecoration: 'underline', marginLeft: 10 }}>
                    Đã có tài khoản ?
                </Link>
            </Form.Item>
        </Form>
