    ...
    <Document>
        <Page style={styles.body}>
            ...
            <View style={styles.containerHeader3}>
                ...
                <Text style={{ marginLeft: 25, fontSize: 13, fontStyle: "italic", color: "black" }}>
                    {`/CN-KDĐV-UQ`}
                </Text>
            </View>
            ...
            <View style={{ display: "flex", flexDirection: "row", flexWrap: "wrap", marginTop: "3px" }}>
                ...
                <View style={{ display: "flex", flexDirection: "row", flexWrap: "wrap", width: "30%" }}>
                    <Text style={{ width: "43%", marginTop: 0, fontSize: 11, color: "black" }}>
                        {`Điện thoại: `}
                    </Text>
                ...
                <View style={{ display: "flex", flexDirection: "row", flexWrap: "wrap", width: "23%" }}>
                    <Text style={{ width: "26%", marginTop: 0, fontSize: 11, color: "black" }}>
                        {`Fax: `}
                    </Text>
                ...
                <View style={{ display: "flex", flexDirection: "row", flexWrap: "wrap", width: "23%" }}>
                    <Text style={{ width: "33%", marginTop: 0, fontSize: 11, color: "black" }}>
                        {`Email: `}
                    </Text>
            ...
            <View style={styles.table}>
                ...
                <View style={[styles.row_body, styles.bold]}>
                    <Text style={[styles.colBody25, { fontStyle: 'bold', color: "black" }]}>{'Tổng số'}</Text>
            ...
            <View style={{ marginTop: "5px", display: "flex", flexDirection: "row", flexWrap: "wrap" }}>
                <Text style={{ width: "28%", marginTop: 0, fontSize: 11, color: "black" }}>
            ...
            <View style={{ marginTop: "2px", height: "30px", display: "flex", flexDirection: "row", flexWrap: "wrap" }}>
                <Text style={{ width: "19%", marginTop: 0, fontSize: 11, maxLines: 1, color: "black" }}>
                    {`Nơi xuất phát: `}
                </Text>
            ...
            <View style={{ height: "30px", display: "flex", flexDirection: "row", flexWrap: "wrap", marginTop: "5px" }}>
                <Text style={{ width: "23%", marginTop: 0, fontSize: 11, maxLines: 1, color: "black" }}>
                    {`Nơi đến cuối cùng: `}
                </Text>
                <Text style={{ fontSize: 11, maxWidth: "81%", maxLines: 2 }}>
                    {`Hồ chí minh `}
            ...
            <View style={{ display: "flex", flexDirection: "row", flexWrap: "wrap", marginTop: "5px" }}>
                ...
                <View style={{ width: "54%", display: "flex", flexDirection: "row", flexWrap: "wrap" }}>
                    <Text style={{ width: "50%", marginTop: 0, fontSize: 11, maxLines: 1, color: "black" }}>
                ...
                <View style={{ width: "46%", display: "flex", flexDirection: "row", flexWrap: "wrap" }}>
                    <Text style={{ width: "37%", marginTop: 0, fontSize: 11, maxLines: 1, color: "black", }}>
                        {`Biển kiểm soát: `}
                    </Text>
                    <Text style={{ fontSize: 11, maxWidth: "50%", maxLines: 1 }}>
                        {`62F1 - 12345`}
            ...
            <View style={{ display: "flex", flexDirection: "row", flexWrap: "wrap", marginTop: "1px", }}>
                ...
                <View style={{ width: "41%", display: "flex", flexDirection: "row", flexWrap: "wrap" }}>
                    <Text style={{ width: "27%", marginTop: 0, fontSize: 11, maxLines: 1, color: "black" }}>
                        {`Số lượng: `}
                    </Text>
            ...
            <View style={{ display: "flex", flexDirection: "row", flexWrap: "wrap" }}>
                <Text style={{ width: "33%", marginTop: 0, fontSize: 11, maxLines: 1, color: "black", }}>
            ...
            <View style={{ height: "55px", marginTop: "8px" }}>
                <Text style={{ fontSize: 11, fontStyle: "bold", textAlign: "center", width: "100%", color: "black" }}>
                    {`CHỨNG NHẬN KIỂM DỊCH`}
                </Text>
                <Text style={{ marginTop: 0, fontSize: 11, fontWeight: "bold", color: "black" }}>
                    {`Tôi, kiểm dịch viên động vật ký tên dưới đây chứng nhận:`}
                </Text>
                <Text style={{ marginTop: 0, fontSize: 11, maxLines: 2, color: "black" }}>
            ...
            <Text style={{ marginTop: "5px", fontSize: 11, fontWeight: "bold", color: "black" }}>
            ...
            <View style={{ height: "45px", marginTop: "3px" }}>
                ...
                <View style={{ display: "flex", flexDirection: "row", flexWrap: "wrap" }}>
                    ...
                    <View style={{ display: "flex", flexDirection: "row", flexWrap: "wrap", width: "49%" }}>
                        <Text style={{ marginTop: 0, fontSize: 11, fontWeight: "bold", width: "55%", color: "black" }}>
                ...
                <View style={{ display: "flex", flexDirection: "row", flexWrap: "wrap" }}>
                    <Text style={{ marginTop: 0, fontSize: 11, fontWeight: "bold", width: "6%", color: "black" }}>
                        {`ngày`}
                    </Text>
                    <Text style={{ marginTop: 0, marginLeft: "3px", fontSize: 11, fontWeight: "bold", width: "4%", textAlign: "right" }}>
                        {`20 `}
                    </Text>
                    ...
                    <Text style={{ marginTop: 0, fontSize: 11, fontWeight: "bold", width: "9%", color: "black" }}>
                        {` của`}
                    </Text>
                    ...
                    <Text style={{ marginTop: 0, fontSize: 11, fontWeight: "bold", width: "25%", fontStyle: "italic", color: "black" }}>
            ...
            <View style={{ display: "flex", flexDirection: "row", flexWrap: "wrap", marginTop: "3px" }}>
                <Text style={{ marginTop: 0, fontSize: 11, fontWeight: "bold", width: "58%", maxLines: 1, marginLeft: "5px" }}>
                    {`đã được tiêm phòng bệnh 1`}
                </Text>
                <Text style={{ marginTop: 0, fontSize: 11, fontWeight: "bold", width: "20%", maxLines: 1, textAlign: "right", color: "black" }}>
                    {`tiêm phòng ngày `}
                </Text>
                <Text style={{ marginTop: 0, fontSize: 11, fontWeight: "bold", width: "6%", textAlign: "right" }}>
                    {`20 `}
            ...
            <View style={{ display: "flex", flexDirection: "row", flexWrap: "wrap" }}>
                <Text style={{ marginTop: 0, fontSize: 11, fontWeight: "bold", width: "29%", color: "black" }}>
            ...
            <View style={{ display: "flex", flexDirection: "row", flexWrap: "wrap", marginTop: 5 }}>
                ...
                <View style={{ display: "flex", flexDirection: "row", flexWrap: "wrap", width: "55%" }}>
                    <Text style={{ marginTop: 0, fontSize: 11, width: "45%", color: "black" }}>
                ...
                <View style={{ width: "45%", textAlign: "center" }}>
                    <View style={{ display: "flex", flexDirection: "row", flexWrap: "wrap" }}>
                        <Text style={{ marginTop: 0, fontSize: 11, width: "16%", color: "black" }}>
                            {`Cấp tại `}
                        </Text>
                        ...
                        <Text style={{ marginTop: 0, fontSize: 11, width: "12%", textAlign: "left", color: "black" }}>
                            {` ngày`}
                        </Text>
                    ...
                    <Text style={{ marginTop: 0, fontSize: 11, fontStyle: "bold", color: "black" }}>
            ...
            <Text style={[styles.note, { fontSize: 8, marginTop: 60, color: "black" }]}>
